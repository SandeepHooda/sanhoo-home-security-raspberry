...
# User Image Settings
# -------------------
imagePath = "/home/pi/picamera-motion/images"    # Folder path to save images
imagePath_dup = "/home/pi/picamera-motion/images_dup"    # Folder path to save images
imageNamePrefix = '' # Prefix for all image file names. Eg front-
imageWidth = 500       # Final image width
imageHeight = 500       # Final image height
...
web_server_root = "/home/pi/picamera-motion/images"    # default= "images" webserver root path to webserver image/video sub-folders
...
# --------------------------
web_image_height = "500"       # default= "768" px height of images to display in iframe
